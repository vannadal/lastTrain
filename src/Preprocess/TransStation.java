	...
	public void Adjecent_Station(String inputFile_transferLinks,String outputFile_Adjecent_TransStation,String outputFile_Adjecent_TransStation_ID)
	{
		...
		try{
			...
			for(i=0;i<line;i++)
			{
				...
				if(station_id[position].equals("S02002"))//2号线是环线，加上末尾邻接换乘站
				{
					for(int k=1;k<20;k++)
					{
				...
				if(station_id[position].equals("S02018"))//2号线是环线，加上首个邻接换乘站
				{
					for(int k=1;k<20;k++)
					{
				...
				if(station_id[position].equals("S10003"))//10号线是环线，加上末尾邻接换乘站
				{
					for(int k=1;k<20;k++)
					{
				...
				if(station_id[position].equals("S10045"))//10号线是环线，加上首个邻接换乘站
				{
					for(int k=1;k<20;k++)
					{
